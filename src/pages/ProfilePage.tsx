    ...
    <div className="home-desktop h-screen w-full overflow-hidden flex flex-col dither-bg">
      <div className="home-mac-window flex-1 min-h-0 m-2 md:m-3 border-2 border-on-background bg-white mac-window-shadow flex flex-col">
        ...
        <div className="flex-1 min-h-0 overflow-y-auto p-4 md:p-6">
          ...
          {/* DeepSeek API key and model configuration. */}
          <section className="mt-4 border-2 border-on-background bg-white mac-window-shadow p-4 md:p-5">
            <div className="flex items-center gap-2 mb-4">
              <span
                className="text-xs font-bold tracking-widest text-on-surface-variant uppercase"
                style={{ fontFamily: 'var(--font-label)' }}
              ...
              <span
                ...
                style={{ fontFamily: 'var(--font-label)' }}
              >
                Keys are stored in VS Code SecretStorage, never in this view
              </span>
            </div>
            <ProviderSettings
              state={providers.state}
              onSetKey={providers.setKey}
              onValidate={providers.validate}
              onClearKey={providers.clearKey}
              onSetModel={providers.setModel}
            />
          </section>
        </div>
      </div>
